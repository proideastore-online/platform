...
</head><body><header><a href="/" class="brand"><span class="mark">PI</span><span>ProIdeaStore</span></a><nav><a href="/#dossiers">Dossiers</a><a href="/about/">About</a><a href="/docs/">Docs</a><a href="/contributors/">Contributors</a><a href="/console/">Console</a><a href="https://freeideastore.online">FreeIdeaStore</a></nav></header><main class="shell">${body}</main></body></html>`, {
...
<body>
<header><a href="/" class="brand"><span class="mark">PI</span><span>ProIdeaStore</span></a><nav><a href="/#dossiers">Dossiers</a><a href="/about/">About</a><a href="/docs/">Docs</a><a href="/contributors/">Contributors</a><a href="/console/">Console</a>${user ? `<a class="account-avatar" href="/profile/" aria-label="Profile">${accountAvatar(user, 36)}</a>` : `<a href="/console/">Sign in</a>`}</nav></header>
<main class="shell">
  ${
    user
...
<body>
<header><a href="/" class="brand"><span class="logo">PI</span><span>ProIdeaStore</span></a><nav><a href="/#dossiers">Dossiers</a><a href="/about/">About</a><a href="/docs/">Docs</a><a href="/contributors/">Contributors</a><a href="/console/">Console</a><a href="https://freeideastore.online">FreeIdeaStore</a></nav></header>
<main class="shell">
